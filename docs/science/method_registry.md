...
| `bocpd_beta_bernoulli` | Bayesian Online Changepoint Detection, Beta-Bernoulli path | adaptation | `adams_mackay_2007` | `BOCPD`, `BOCPDConfig`, `BOCPDAlertConfig`, `BOCPDResult`, hazards | `src/changepoint_lab/algorithms/bayesian/bocpd/core.py`; `src/changepoint_lab/algorithms/bayesian/bocpd/likelihoods.py`; `src/changepoint_lab/algorithms/bayesian/bocpd/__init__.py` | partially_verified |
