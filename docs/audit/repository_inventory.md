...
- Editable install in a clean virtual environment succeeded and imported `changepoint_lab.__version__ == "0.1.7"`.
- `python -m build` succeeded and produced wheel and sdist.
- Wheel installation in a clean virtual environment succeeded and imported `changepoint_lab.__version__ == "0.1.7"`.
...
- Current version in package metadata, runtime, CFF, and Zenodo JSON: `0.1.7`
